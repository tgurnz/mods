...
#============================================================= 
<#
RC_SingleOffice.ps1 will detect the single office version installed rootcause
Arguments:
None
...
#Load parameters...
PARAM($rcName, $rcDescription, $officeID,$count)

#Call the rootcause...
Update-DiagRootCause -id "RC_SingleOffice" -detected $true -Parameter @{'rcName' = $rcName;'rcDescription' = $rcDescription; 'officeID' = $officeID; 'count' = $count}

# SIG # Begin signature block
# MIIdoAYJKoZIhvcNAQcCoIIdkTCCHY0CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDFqa0+XfUk1M7I2zJgaERBpj
# 3nCgghhkMIIEwzCCA6ugAwIBAgITMwAAAMvZUgZTvz4qWQAAAAAAyzANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUDHbuBHtGXDgKvYM3eta6DiStZ7gwWgYKKwYB
# BAGCNwIBDDFMMEqgMIAuAE8AVQA0AF8AUgBDAF8AUwBpAG4AZwBsAGUATwBmAGYA
# aQBjAGUALgBwAHMAMaEWgBRodHRwOi8vbWljcm9zb2Z0LmNvbTANBgkqhkiG9w0B
# AQEFAASCAQCEo3OUOLktKFElhtsuefhEsGzf872HPFlb3rngldjfqj9JpIysZ+b9
# 9WzSvA0YlNeeFbPAxr91eAPaJpgvHMUKKwkpoYL7YDINzjaOBLrs4nU1fdJO+DEA
# 8v3u/LmxScLa9s/C1vrk8aHsTgUlCh+JqjjkZC2Uy3pXgQk7xKVXMel0RWCu0kaa
# jMHp1j939vceoNj+JzppqI3njwHm6Za3mLhjBaV9gJoPP7F0Kw0Bqi4BOL9js+EO
# 4gfdCF921ladxno4BenZ0YLR/9JxeEEuhHelT7AYTqQmK9mNElcaUU9bJzvdhlnq
# eXqvI3i4yyuAN2+ZLpBA+x4XsPDstTnToYICKDCCAiQGCSqGSIb3DQEJBjGCAhUw
...
# BgkqhkiG9w0BCQUxDxcNMTYxMTMwMjA1ODMyWjAjBgkqhkiG9w0BCQQxFgQU6L8N
# qm0lPLTQokMOctGFVtSsm68wDQYJKoZIhvcNAQEFBQAEggEADHUcZCwqDWqONSWH
# NLe1d8sFFZmpdHCSxbuo3XQ3O2bUYo+V1KdntWo+BrZWV/2Tx4ysd14RKfOY4oiM
# +KAfTctvhfXKwYhFltjKmUonDHSjcsR4KD+Jk/7fTkWU9oNDmeK96Yw41Dw4It2b
# shaVqI5PBFC57i4CbHq9A8nRbpbgrYgCeMySq7MeJdCzePBTsOoSYlKyzqD40IeL
# lFXzJHuhxUYhJ7HAg1l1m1wheb41FoummLB8O75wjoBFoV0znCv+HqnhvDKknMtJ
# sdc2mcOwslZdErOMrZWcYB4g2PnFDSoYyaSqlztp+fNGqpGYzH9YfMiKXYh5nmx3
# f1qKiQ==
